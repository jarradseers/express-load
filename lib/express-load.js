...
ExpressLoad.prototype.then = function(location) {
  ...
  var loc = this.options.cwd ? this.options.cwd + path.sep + location.replace('/', path.sep) : location.replace('/', path.sep);
