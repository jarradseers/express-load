...
ExpressLoad.prototype.__log = function(message, type) {
  if (this.options.verbose) {
    ...
    switch (type) {
      ...
      case 'error':
        this.options.logger.error(this.options.logFormat, title, message);
      break;

      case 'warn':
        this.options.logger.warn(this.options.logFormat, title, message);
      break;

      default:
        this.options.logger.info(this.options.logFormat, title, message);
      break;
    }
  }
